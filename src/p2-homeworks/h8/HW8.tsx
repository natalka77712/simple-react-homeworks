...
import {homeWorkReducer, SortNameDownAC, SortNameUpAC, SortPersonAgeAC} from "./bll/homeWorkReducer";
...
function HW8() {
    ...
    const checkAge = () => setPeople(homeWorkReducer(initialPeople, SortPersonAgeAC()))
